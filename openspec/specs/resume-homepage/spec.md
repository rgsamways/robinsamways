...
The Experience section SHALL list, in reverse chronological order, each of: Farpost (2025 — Present), Impres Pharma (2012 — 2025), FileTrack Solutions (2009 — 2012), Padre Software (2004 — 2009), Concept Interactive (2001 — 2004), and Instructor at George Brown College (c. 2000). Each entry SHALL show the employer/role name, a right-aligned accent-colored date range, and line items prefixed with a `›` arrow bullet.
