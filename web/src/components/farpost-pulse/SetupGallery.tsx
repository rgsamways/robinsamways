...
// Empty until Robin captures real Azure Function App / Cosmos DB
// screenshots (per experiments-record-pages' design.md) — the component
// and page are complete and ready to render real items the moment they
// exist.
  ...
  if (GALLERY_ITEMS.length === 0) {
    return (
      <p className="text-sm leading-relaxed">
        Screenshots coming soon &mdash; the real Azure Function App setup,
        Cosmos DB account/container configuration, and CORS setup for
        robinsamways.ca haven&rsquo;t been captured yet. This page ships as
        an honest placeholder until they are, the same pattern as this
