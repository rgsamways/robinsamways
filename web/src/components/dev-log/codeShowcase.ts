// D1 (dev-log-topics): one level above `category` — a fixed 5-value
// taxonomy every entry maps onto exactly one of, so the hub page can filter
// by something coarser than category without a second, derived lookup
// table living apart from the entries themselves.
export type Topic =
  | "Engineering"
...
export type CodeShowcaseEntry = {
  ...
  topic: Topic;
  date: string;
  // Exact time-of-day wasn't recorded when these entries were first written,
  // so each gets a placeholder time spaced through the day they're dated —
  // the date itself is real, the hour/minute is not.
...
export const CODE_SHOWCASE_ENTRIES: CodeShowcaseEntry[] = [
  {
    ...
    topic: "Engineering",
    date: "2026-07-15",
    publishedAtUtc: "2026-07-15T13:00:00Z",
    title: "The Bug That Silently Ate 2,706 Records",
    teaser: "A batch-loading race condition let two colliding slugs silently swallow 2,706 real records.",
    framing: [
  ...
  },
  {
    ...
    topic: "Engineering",
    date: "2026-07-15",
    publishedAtUtc: "2026-07-15T13:45:00Z",
    title: "A Generic Dispatch Loop, Built Before It Needed to Be",
    teaser: "A dispatch loop built generic before a second consumer existed — and got the one subtle correctness detail right.",
    framing: [
  ...
  },
  {
    ...
    topic: "Engineering",
    date: "2026-07-15",
    publishedAtUtc: "2026-07-15T14:30:00Z",
    title: "Scoring a Blank Slate Without Lying About It",
    teaser: "Scoring a professional with zero history without dishonestly calling them average.",
    framing: [
  ...
  },
  {
    ...
    topic: "Engineering",
    date: "2026-07-15",
    publishedAtUtc: "2026-07-15T15:15:00Z",
    title: "Two Weak Signals Beat One Strong-Looking One",
    teaser: "Two independent weak signals beat trusting one strong-looking string match alone.",
    framing: [
  ...
  },
  {
    ...
    topic: "Engineering",
    date: "2026-07-15",
    publishedAtUtc: "2026-07-15T16:00:00Z",
    title: "The Fix That Almost Reopened the Bug It Fixed",
    teaser: "A caching fix for one Stripe race quietly opened a second, quieter one — fixed by verifying, not un-caching.",
    framing: [
  ...
  },
  {
    ...
    topic: "Engineering",
    date: "2026-07-15",
    publishedAtUtc: "2026-07-15T16:45:00Z",
    title: "A Stripe Default That Produces a $0 Invoice — Silently",
    teaser: "A missing Stripe parameter silently produces a $0, auto-paid invoice.",
    framing: [
...
async def finalize_and_send_platform_fee_invoice(invoice_id: str, fee_cents: int) -> str | None:
  ...
  },
  {
    ...
    topic: "Engineering",
    date: "2026-07-15",
    publishedAtUtc: "2026-07-15T17:30:00Z",
    title: "The Webhook Redelivery Stripe Warns You About",
    teaser: "Stripe's own redelivery warning, ignored once, silently corrupted a paid-date.",
    framing: [
  ...
  },
  {
    ...
    topic: "Engineering",
    date: "2026-07-15",
    publishedAtUtc: "2026-07-15T18:15:00Z",
    title: "When the Infrastructure Lies About Its Own URL",
    teaser: "Production infrastructure quietly rewrote a URL's scheme, breaking every webhook signature check.",
    framing: [
  ...
  },
  {
    ...
    topic: "Engineering",
    date: "2026-07-15",
    publishedAtUtc: "2026-07-15T19:00:00Z",
    title: "Not Every Fact Goes Stale at the Same Rate",
    teaser: "Not every fact about a building goes stale at the same rate — so neither does its tracking.",
    framing: [
...
async def get_due_for_fact_decay(self) -> list[Building]:
  ...
  },
  {
    ...
    topic: "Engineering",
    date: "2026-07-15",
    publishedAtUtc: "2026-07-15T19:45:00Z",
    title: "Respecting the Event Loop When Wiring Up Claude",
    teaser: "A blocking AI SDK call wrapped so it can't stall every other concurrent request.",
    framing: [
...
async def preen_contribution(raw_text: str, role: str) -> dict:
  ...
  {
    slug: "minor-change-real-scope",
    project: "robinsamways.ca",
    category: "AI-Assisted Development",
    topic: "Process & Verification",
    date: "2026-07-26",
    publishedAtUtc: "2026-07-26T15:00:00Z",
    ...
    codeBlocks: [
      {
        language: "markdown",
        code: `D4 — Session-conditional icon via a \`data-signed-in\` attribute on \`<html>\`, not
...
or out without a full reload.`,
  ...
  {
    slug: "same-source-different-story",
    project: "robinsamways.ca",
    category: "AI-Assisted Development",
    topic: "Process & Verification",
    date: "2026-07-26",
    publishedAtUtc: "2026-07-26T15:30:00Z",
    ...
    codeBlocks: [
      {
        language: "text",
        code: `published:      "A Generic Dispatch Loop, Built Before It Needed to Be"
...
this session:   "A Roof Goes Stale Faster Than a Foundation"`,
  ...
  {
    slug: "drift-audit-doesnt-self-verify",
    project: "robinsamways.ca",
    category: "AI-Assisted Development",
    topic: "Process & Verification",
    date: "2026-07-26",
    publishedAtUtc: "2026-07-26T16:00:00Z",
    ...
    codeBlocks: [
      {
        language: "markdown",
        code: `before: "Activating the menu button again, pressing Escape, or selecting a
...
after:  "Pressing Escape, activating the panel's own explicit close control,
  ...
  {
    slug: "ai-interview-format-mismatch",
    project: "robinsamways.ca",
    category: "Interview Process",
    topic: "Human Factors",
    date: "2026-07-24",
    publishedAtUtc: "2026-07-24T22:00:00Z",
    ...
    codeBlocks: [
      {
        language: "text",
        code: `interview format tested:  cold, timed, verbal recall of syntax terminology
what actually held up:    diagnosing an off-by-one loop bug and explaining
  ...
  {
    slug: "billing-model-convergence",
    project: "robinsamways.ca",
    category: "Business Model",
    topic: "Business Model",
    date: "2026-07-24",
    publishedAtUtc: "2026-07-24T20:00:00Z",
    ...
    codeBlocks: [
      {
        language: "text",
        code: `Project A's own idea (unbuilt, logged earlier): buy 50 tokens / $20, spend 1 per use
...
Same shape. Different names. Neither copied the other.`,
  ...
  {
    slug: "fastify-vs-express-tradeoff",
    project: "robinsamways.ca",
    category: "Stack Decisions",
    topic: "Architecture & Stack Decisions",
    date: "2026-07-24",
    publishedAtUtc: "2026-07-24T18:00:00Z",
    ...
    codeBlocks: [
      {
        language: "text",
        code: `Express: no major version 2014 -> Oct 2024 (v5); correct built-in async
...
Fastify: chosen anyway, for the technical reasons above`,
  ...
  {
    slug: "golden-path-not-planned",
    project: "robinsamways.ca",
    category: "Platform Engineering",
    topic: "Architecture & Stack Decisions",
    date: "2026-07-24",
    publishedAtUtc: "2026-07-24T19:00:00Z",
    ...
    codeBlocks: [
      {
        language: "text",
        code: `what got built:                       the industry term for it:
...
propose -> validate -> archive         ADR / RFC-driven development
  ...
  {
    slug: "found-my-own-stack",
    project: "robinsamways.ca",
    category: "Stack Decisions",
    topic: "Architecture & Stack Decisions",
    date: "2026-07-24",
    publishedAtUtc: "2026-07-24T17:00:00Z",
    ...
    codeBlocks: [
      {
        language: "text",
        code: `Project A's real dependencies (checked directly, not assumed):
...
The decision was already made. It just hadn't been named yet.`,
  ...
  {
    slug: "role-modeled-twice",
    project: "Farpost",
    category: "Data Modeling",
    topic: "Engineering",
    date: "2026-07-24",
    publishedAtUtc: "2026-07-24T21:00:00Z",
    ...
    codeBlocks: [
      {
        language: "python",
        code: `class Professional(Document):
...
class Adjuster(Document):
  ...
  {
    slug: "how-this-site-actually-gets-tested",
    project: "robinsamways.ca",
    category: "Verification Practice",
    topic: "Process & Verification",
    date: "2026-07-10",
    publishedAtUtc: "2026-07-10T18:00:00Z",
    ...
    codeBlocks: [
      {
        language: "text",
        code: `Playwright         -> real browser-driven UI checks
...
no CI / no persistent suite -> deliberate, stated trade-off at this scale`,
  ...
  {
    slug: "three-prices-in-three-days",
    project: "Vocare",
    category: "Business Model",
    topic: "Business Model",
    date: "2026-07-24",
    publishedAtUtc: "2026-07-24T23:00:00Z",
    ...
    codeBlocks: [
      {
        language: "text",
        code: `day 1: one-time $10 lifetime unlock
