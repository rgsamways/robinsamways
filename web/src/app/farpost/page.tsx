      ...
      node: (
        <section>
          ...
          <div className="space-y-4 text-sm leading-relaxed">
            <p>
              I didn&rsquo;t set out to build a building-intelligence
              platform. In late May 2026, an insurance adjuster I knew had a
              rural claim and couldn&rsquo;t find anyone to work it — no
              contractor, no inspector willing to make the drive out from
              the city for one job. It wasn&rsquo;t a technology problem, it
              was an availability problem nobody&rsquo;s software was built
              to solve. I built a dispatch app in about a week to fix
              exactly that: get the right professional to the right claim,
            ...
            <p>
              ...
              similar. The same thing, down to a striking number of
              features I&rsquo;d built without ever knowing theirs existed.
              That&rsquo;s a hard thing to sit with three weeks in, and
              there wasn&rsquo;t a version of finishing TapLog that still
              made sense, so I stopped.
            </p>
            <p>
              I didn&rsquo;t throw the idea away, though. The part of
              TapLog that actually mattered — an RFID tag verifying a
              physical location, logging what happened there over time —
              got folded straight into the dispatch app I&rsquo;d already
              built. Dispatch the right professional to the right
              building, and keep a real, tag-verified record of what
              happened at that building afterward. That fusion, arrived at
              by mid-June 2026, is what Farpost actually is.
            </p>
          </div>
        </section>
      ),
        ...
        <section>
          ...
          <div className="space-y-4 text-sm leading-relaxed">
            <p>
              ...
              who did the roof and when, where the warranty and manuals
              live — exist in exactly one place today: a single
              owner&rsquo;s head. When that person sells, retires, or just
              forgets, the knowledge is gone with them. Farpost anchors
              those facts to the building itself, via an NFC tag on the
              physical structure, so they survive the person. It pays off
              at 2am hunting a water shutoff, at a sale, or handing a job to
              a new contractor who&rsquo;s never set foot in the building
              before. This is the core value proposition, deliberately
              designed to work for a single owner with zero network effect
              — nobody else has to be using Farpost for it to already be
              useful.
            </p>
            <p>
              <strong>
                The rural service-availability gap — where this all
                started.
              </strong>{" "}
              ...
              never get found for that work. It&rsquo;s real, live, and
              still fully supported — it&rsquo;s just no longer the
              platform&rsquo;s defining feature, since the &ldquo;it dies
              with the owner&rdquo; problem turned out to be the deeper,
              more durable one.
            </p>
            <p>
            ...
            <p>
              ...
              happens to be active at the time. Farpost is carrier-neutral
              by design — the &ldquo;Switzerland&rdquo; that owners,
              brokers, and contractors can all trust — so the record
              survives a carrier switch. No insurer would ever build this
              themselves: they&rsquo;re structurally conflicted, and an
              insurer-owned version of this record could never actually be
              neutral.
            </p>
            <p>
              <strong>
      ...
      node: (
        <section>
          ...
          <div className="mb-4 border-l-4 border-accent bg-skills-bg px-4 py-3 text-sm">
            ...
            behaves over a building&rsquo;s life — not a real property, but
            a realistic composite of what the platform is for.
          </div>
    ...
    },
    {
      ...
      node: (
        <section>
          ...
          <div className="space-y-4 text-sm leading-relaxed">
            <p>
              Building Farpost solo means there&rsquo;s no one else to
              catch drift between what a feature was supposed to do and
              what it actually does — so I built that check into the
              process itself. Every non-trivial change starts as a written
              proposal (what&rsquo;s changing, why, and the exact behavior
              expected of it) before any code gets written, and nothing
              merges until a deliberate drift audit confirms the shipped
              behavior actually matches what was proposed — not just that
              it works, but that it works the way it was supposed to.
              It&rsquo;s the same discipline behind this site&rsquo;s own
              Salesforce case study, built the same way: propose,
              implement, audit for drift, then finalize.
            </p>
            <p>
              Alongside that, I keep a contemporaneous log of genuine
              technical uncertainty resolved through real experimentation,
              written down as I hit it — not reconstructed from memory
              after the fact. It&rsquo;s the same discipline Canadian{" "}
              {"SR&ED"} tax credits ask of {"R&D"} work, kept up because
              it&rsquo;s good practice for hard problems regardless of the
              tax angle, and it&rsquo;s paid off enough as its own habit
              that it&rsquo;s becoming a small project in its own right.
            </p>
          </div>
        </section>
      ),
