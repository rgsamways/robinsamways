...
export default function DevLogPage() {
  ...
  const sections = [
      ...
      node: (
        <section>
          ...
          <p className="mb-4 text-sm leading-relaxed">
            A growing "X, in layman's terms" list — plain-language explanations
            of tools and concepts used elsewhere on this site, for a reader who
      ...
      node: (
        <section>
          ...
          <p className="mb-4 text-sm leading-relaxed">
            ...
            underlying concept it reveals — the messy, unpolished record, not
    ...
    },
    {
      ...
      node: (
        <section>
          <SectionHeader title="CODE_SHOWCASE" />
          <p className="mb-4 text-sm leading-relaxed">
